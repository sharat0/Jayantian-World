...
Public Class pending
    ...
    Private Function GetData() As DataTable
        ...
        If branch = "admin" Then
            Try
                Using cmd As New SqlCommand("SELECT id, name, type, programme FROM form1 where app_status='0'")
        ...
        Else
            Try
                ...
                Using cmd As New SqlCommand("SELECT id, name, type, programme FROM form1 where type= '" + branch + "' and app_status=0")
                    Using sda As New SqlDataAdapter()
                        cmd.Connection = con
                        sda.SelectCommand = cmd
                        Using dt As New DataTable()
