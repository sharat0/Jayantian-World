...
<head runat="server">
    ...
    <body>
      <div id="nav">
        <ul>
            ...
            <!-- <li id="nav_btn"><a href="#" id="login">Login</a></li>
    ...
    <div id="form">
        ...
        <form id="form1" runat="server">
            ...
            <span class="label">Name :</span> <input type="text" name="name" id="name" required/>

            <br/>

            <span class="label">Programme Category : </span>
            <%--<asp:RadioButton ID="RadioButton1" runat="server" Text="Under Graduate" GroupName="programme" value="ug" />  
            <asp:RadioButton ID="RadioButton2" runat="server" Text="Post Graduate" GroupName="programme" value="pg" />
            <asp:RadioButton ID="RadioButton3" runat="server" Text="Law" GroupName="programme" value="law" />--%>

            <asp:RadioButtonList ID="programme" runat="server">
